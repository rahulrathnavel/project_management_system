...
## 1. GitHub Repository
[https://github.com/rahulrathnavel/project_management_system.git](https://github.com/rahulrathnavel/project_management_system.git)

## 2. Live Application URL
**Frontend**: [https://pms-web-8dzr.onrender.com/](https://pms-web-8dzr.onrender.com/)

*(The application is fully hosted on Render. You can register a new user or use the test credentials provided separately if applicable).*

## 3. Database Schema / ER Diagram
[docs/ER_DIAGRAM.md](ER_DIAGRAM.md)

## 4. API Documentation
**Production Swagger**: [https://pms-api-xxxx.onrender.com/api/docs](https://pms-api-xxxx.onrender.com/api/docs) *(Note: Substitute the exact API URL generated by Render during your testing).*
